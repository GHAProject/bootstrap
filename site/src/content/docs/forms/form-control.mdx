...
<Example code={`<div class="mb-3">
  ...
  <div class="mb-3">
    <label for="defaultTextarea" class="form-label">Default textarea</label>
    <textarea class="form-control" id="defaultTextarea" rows="3" placeholder="Default textarea" aria-label="Default textarea example"></textarea>
  </div>`} />
